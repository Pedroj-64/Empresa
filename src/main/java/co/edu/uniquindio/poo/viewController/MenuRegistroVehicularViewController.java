...
public class MenuRegistroVehicularViewController {
    ...
    private void registrarVehiculo() {
        try {
            ...
            App.showAlert("Error de Entrada", "Por favor, ingrese un valor numérico válido para la tarifa base, capacidad de carga o número de puertas.", Alert.AlertType.WARNING);
        } catch (Exception e) {
